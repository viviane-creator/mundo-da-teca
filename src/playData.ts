...
const laboratorioSeeds: ExperienceSeed[] = [
  {
    id: "ovo-saltador",
    title: "ovo saltador",
    invite: "um ovo comum aprende um jeito novo de quicar.",
    materials: "ovo cozido, vinagre, pote de vidro",
    people: "criança e adulto",
    place: "cozinha, bancada",
  },
  {
    id: "carta-invisivel",
    title: "carta invisível",
    invite: "uma mensagem secreta aparece quando o papel aquece.",
    materials: "suco de limão, cotonete, papel, fonte de calor com adulto",
    people: "criança e adulto",
    place: "mesa da cozinha",
  },
  {
    id: "pocoes-cores-vivas",
    title: "poções de cores vivas",
    invite: "misturas pequenas viram frascos de cor em transformação.",
    materials: "água, corantes, potes transparentes",
    people: "adulto e criança",
    place: "cozinha, mesa",
  },
  {
    id: "leite-psicodelico",
    title: "leite psicodélico",
    invite: "cores dançam sobre o leite como uma aquarela viva.",
    materials: "leite, corante alimentício, detergente, prato",
    people: "criança e adulto",
    place: "cozinha",
  },
  {
    id: "pintura-flutuante",
    title: "pintura flutuante",
    invite: "a tinta boia na água antes de pousar no papel.",
    materials: "água, tinta, recipiente raso, papel",
    people: "criança e adulto",
    place: "mesa protegida",
  },
  {
    id: "agua-solida",
    title: "água sólida",
    invite: "a água muda de estado e vira escultura fria.",
    materials: "água, congelador, formas de gelo",
    people: "criança e adulto",
    place: "cozinha",
  },
  {
    id: "papel-que-encolhe",
    title: "papel que encolhe",
    invite: "um desenho cresce no olhar e encolhe no forno.",
    materials: "plástico encolhível, lápis de cor, forno com adulto",
    people: "criança e adulto",
    place: "cozinha, bancada",
  },
  {
    ...
    invite: "fibras molhadas se encontram e nascem em nova folha.",
    materials: "retalhos de papel, água, peneira fina",
    people: "adulto e criança",
    place: "cozinha, tanque",
  },
  {
    id: "agua-que-anda",
    title: "água que anda",
    invite: "a água atravessa o papel e visita outro copo sozinha.",
    materials: "copos, água colorida, papel-toalha",
    people: "criança e adulto",
    place: "mesa da cozinha",
  },
  {
    id: "flores-esquecidas",
    title: "flores esquecidas",
    invite: "flores prensadas guardam o tempo entre páginas.",
    materials: "flores pequenas, papel, livro pesado",
    people: "criança e adulto",
    place: "mesa, quarto",
  },
  {
    id: "tintas-nascidas-da-cozinha",
    title: "tintas nascidas da cozinha",
    invite: "beterraba, cúrcuma e café viram paleta de laboratório.",
    materials: "ingredientes naturais, água, potes",
    people: "criança e adulto",
    place: "cozinha",
  },
  {
    id: "papel-semente",
    title: "papel semente",
    invite: "uma folha guarda sementes para brotar depois.",
    materials: "massa de papel, sementes pequenas, água",
    people: "criança e adulto",
    place: "mesa, quintal",
  },
  {
    id: "carimbos-improvaveis",
    title: "carimbos improváveis",
    invite: "objetos comuns deixam marcas inesperadas no papel.",
    materials: "esponjas, tampas, legumes, tinta",
    people: "criança e adulto",
    place: "mesa protegida",
  },
  {
    id: "cobra-de-espuma",
    title: "cobra de espuma",
    invite: "uma serpente de bolhas cresce do gargalo da garrafa.",
    materials: "garrafa, meia, detergente, água, corante",
    people: "adulto e criança",
    place: "área externa",
  },
  {
    id: "monstro-que-respira",
    title: "monstro que respira",
    invite: "um balão parece ganhar fôlego dentro da garrafa.",
    materials: "garrafa, balão, água quente e fria com adulto",
    people: "adulto e criança",
    place: "cozinha, bancada",
  },
]
